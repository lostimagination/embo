...
if ( ! function_exists( 'it_wpdocs_theme_add_editor_styles' ) ) {
	 ...
	 * @return void
	 */
	function it_wpdocs_theme_add_editor_styles(): void {
...
if ( ! function_exists( 'it_tiny_mce_style_formats' ) ) {
	 ...
	 */
	function it_tiny_mce_style_formats( array $styles ): array {
...
if ( ! function_exists( 'it_tiny_mce_before_init_formats' ) ) {
	 ...
	 */
	function it_tiny_mce_before_init_formats( array $settings ): array {
...
if ( ! function_exists( 'it_tiny_mce_before_init_colors' ) ) {
	 ...
	 */
	function it_tiny_mce_before_init_colors( array $init ): array {
